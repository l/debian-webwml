...
\htlink{stable/main/source/misc/}
{ftp://ftp.es.debian.org/debian/stable/main/source/misc}.
...
que deben seguir unas reglas definidas en la \htlink{Política de
Paquetes de Debian}{http://www.es.debian.org/doc/debian-policy}, en la
...
sus desarrolladores, esto no es la norma general, el \htlink{compromiso
principal de Debian}{http://www.es.debian.org/social\_contract} es el de hacer disponible programas de libre
...
/usr/doc/debian}. Las \htlink{listas de
distribución}{http://www.es.debian.org/MailingLists} también son una
fuente importante de información, se encuentran \htlink{indexadas en
el servidor de Debian}{http://www.debian.org/Lists-Archives}, en
